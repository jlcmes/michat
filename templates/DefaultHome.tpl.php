...
?>
	...
	<div class="modal hide fade" id="getStartedDialog">
		<div class="modal-header">
			...
			<h3>MICHAT EXAMPLE WEB APPLICATION</h3>
		</div>
	...
	<div class="container">
		...
		<div class="hero-unit">
			...
			<p>This application has been developed and designed in only a few hours, and hence, it might need some improvements to make it production-ready. Please sign up for free in <a href='http://www.micuadernodecampo.es'>"Mi Cuaderno de Campo"</a> to try a web app I developed using the same framework.</p>

			<p>Please read the "README.md" file for suggested improvements and comments.</p>

			<p><strong>Administration: <a href="./loginform">Login</a> with admin/123</strong></p>
			<p><strong>User access: Login into the <a href="./mobile">Mobile Client</a> with user1/123</strong></p>
