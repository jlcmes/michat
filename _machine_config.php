...
GlobalConfig::$CONNECTION_SETTING->DBName = "michat";
...
/** the root url of the application with trailing slash, for example http://localhost/michat/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'michat/';
