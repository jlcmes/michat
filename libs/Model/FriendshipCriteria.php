...
require_once("DAO/FriendshipCriteriaDAO.php");

/**
 * The FriendshipCriteria class extends FriendshipDAOCriteria and is used
 ...
 * @version 1.0
 */
class FriendshipCriteria extends FriendshipCriteriaDAO
{
