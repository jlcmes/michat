...
require_once("DAO/MessageCriteriaDAO.php");

/**
 * The MessageCriteria class extends MessageDAOCriteria and is used
 ...
 * @version 1.0
 */
class MessageCriteria extends MessageCriteriaDAO
{
