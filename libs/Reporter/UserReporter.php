	...
	*/
	static function GetCustomQuery($criteria)
	{
		$sql = "select
			...
			,`user`.`u_password` as Password
			,`user`.`u_last_seen` as LastSeen
			,`user`.`u_connected` as Connected
			,`user`.`u_public_profile` as PublicProfile
			,`user`.`u_public_key` as PublicKey
		from `user`";
